...
<html>
<head>
<!-- 이곳에 head사이에  bootstrap을 갖다 붙이면 좀더 세련되게 꾸밀 수 있다  -->
...
<%--현재 파일인 req_user_form.jsp에 폼 태그를 만들어보겠습니다.
	...
	이  름 : <input type= "text" name="uname" placeholder="이름"/><br/>
	...
	<%--input 태그 내부에 value 값을 이용해 선택되었을때 전달될 데이터를 정할 수 있습니다.--%>
		...
		<input type= "checkbox" name="hobby"value="넷플보기">넷플보기 &nbsp; 
		<input type= "checkbox" name="hobby"value="산책">산책 &nbsp; 
		<input type= "checkbox" name="hobby"value="카페가기">카페가기 &nbsp; 
		<input type= "checkbox" name="hobby"value="쇼핑하기">쇼핑하기 &nbsp; 
		<hr/>
	혈액형 :

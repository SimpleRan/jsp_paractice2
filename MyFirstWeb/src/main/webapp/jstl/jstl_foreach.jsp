...
<%--
	...
	out.println("총합은" + total + "입니다.");
--%>

	<!-- begin = '시작값', end = '끝값(포함)', stap='숫자증가량', var='변수명'
	c:forEach 구문은 for문을 대체합니다. -->
	...
	<%--변수 arr내부자료 ["사과", "딸기", "망고", "바나나", "포도"]를 순차적으로 출력해보겠습니다. --%>

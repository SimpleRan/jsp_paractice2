<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--페이지 내부에서 c태그라이브러리를 써서 태그화 하고 싶다면 디렉티브를 이요해 선언해줍니다. --%>
...
<body>
	<!-- name이 홍길동으로 들어오는 경우만 화면에 "name 파라미터로 들어온 값은 홍길동입니다."라고 출력
	...
	<!--form에서 보낸 데이터를 받아서 변수로 저장하기  -->	
	<c:set var="fAge" value="${param.age }"/>
	<c:out value="${fName}의 나이는 ${fAge}세 입니다."/><br/>
